...
export class Sim {
  ...
  _substep() {
    ...
    for (let i = 0; i < this.count; i++) {
      ...
      // The separation drift is folded in before the cap, not after. Added
      // afterwards it would be unbounded, and escalating it (see _computeSpread)
      // could then carry a strand clean through another between checks.
      if (sp) {
